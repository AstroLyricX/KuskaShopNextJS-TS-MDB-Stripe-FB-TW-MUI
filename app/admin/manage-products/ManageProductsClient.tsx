...
export const ManageProductsClient: React.FC<ManageProductsClientProps> = ({
  products,
}) => {
  ...
  const handleDelete = useCallback(
    async (id: string, images: any[]) => {
      toast("Eliminando producto, por favor espera.");
      ...
      const handleImageDelete = async () => {
        try {
          ...
          return console.log("Deleting images errot", error);
        }
      };
